...
async def fetch_visits_for_day_three_buckets(db: AsyncSession, dt: date) -> List[dict]:
    ...
    stmt = (
        select(
            ...
            Visit.primary_ins_id.label("primary_ins_id"),
            Visit.primary_insurance.label("primary_insurance"),
            Visit.secondary_ins_id.label("secondary_ins_id"),
            Visit.secondary_insurance.label("secondary_insurance"),
            Visit.ref_provider_npi.label("ref_provider_npi"),
            Visit.referring_provider.label("referring_provider"),
            ...
            Visit.cpt_code.label("cpt_code"),
            Visit.auth_number.label("auth_number"),
            Visit.rendering_provider_npi.label("rendering_provider_npi"),
        ...
        out.append(
            {
                ...
                "case_id": r.get("case_id"),
                "case_description": r.get("case_description") or "",
                "primary_ins_id": r.get("primary_ins_id") or "",
                "primary_insurance": r.get("primary_insurance") or "",
                "secondary_ins_id": r.get("secondary_ins_id") or "",
                "secondary_insurance": r.get("secondary_insurance") or "",
                "ref_provider_npi": r.get("ref_provider_npi") or "",
                "referring_provider": r.get("referring_provider") or "",
                "diagnosis": r.get("diagnosis") or "",
                "medical_diagnosis": r.get("medical_diagnosis") or "",
                "visiting_therapist": r.get("visiting_therapist") or "",
                "cpt_code": r.get("cpt_code") or "",
                "auth_number": r.get("auth_number") or "",
